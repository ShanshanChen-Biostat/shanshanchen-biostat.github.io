...
of up to 100 Hz. When used for tracking daily activity levels,
data from the 3-axis accelerometer are often transformed into
vector magnitudes and aggregated minute by minute, using
